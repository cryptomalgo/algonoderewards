...
function PrivacyPolicy() {
  return (
    <>
      <title>Privacy Policy • AlgoNodeRewards</title>
      <meta
        name="description"
        content="Learn how AlgoNodeRewards handles your data and protects your privacy. Open-source, frontend-only application with no server-side data collection."
      />
      <link rel="canonical" href="https://algonoderewards.com/privacy-policy" />
      <meta
        property="og:url"
        content="https://algonoderewards.com/privacy-policy"
      />
        ...
        <div className="mx-auto max-w-4xl py-10">
          ...
          <div className="mt-12 space-y-12 text-left">
            ...
            <section>
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-300">
                  AlgoNodeRewards is an open-source, frontend-only web
                  application that displays statistics and analytics for
                  Algorand node rewards. I am committed to protecting your
                  privacy and being transparent about any data processing that
                  occurs when you use this website.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-300">
                  By using this website, you agree to this Privacy Policy. If
                  you do not agree with this policy, please do not use the site.
                </p>
                <p className="mt-2 text-gray-600 dark:text-gray-300">
                  If I make material changes to this policy, I will update the
                  "Last Updated" date above. Your continued use of the site
            ...
            <section>
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  store data locally on your device, which can improve
                  performance and reduce API requests.
                </p>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  When you enable caching, the following public blockchain data
                ...
                <ul className="mt-2 list-inside list-disc space-y-2 text-gray-600 dark:text-gray-300">
                  ...
                  <li>
                    You can also clear browser data through your browser
                    settings
                  </li>
                </ul>
              </div>
            ...
            <section>
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  I use the Binance public API to retrieve real-time USD
                  exchange rates for Algorand. This connection does not transmit
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  ) to convert .algo addresses to wallet addresses. This API
                  does not transmit any personal information from you.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-300">
                  Important: I have not enabled Real User Monitoring (RUM) on
                  the Cloudflare Pages deployment, which means no enhanced
                  tracking or analytics beacon is injected into the website.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  purposes. However, some third-party providers used by this
                  site (for example, Binance or other embedded services) may set
                  their own cookies according to their policies. I do not
                  control these cookies. Please refer to the respective
            ...
            <section>
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-300">
                  ...
                  Cloudflare is retained according to their retention policies
                  and is not under my direct control.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="mt-2 list-inside list-disc space-y-2 text-gray-600 dark:text-gray-300">
                <li>
                  <strong>November 19, 2025:</strong> Added section on local
                  data storage (IndexedDB) caching mechanism, clarifying that
                  caching is disabled by default and requires opt-in
                </li>
                <li>
